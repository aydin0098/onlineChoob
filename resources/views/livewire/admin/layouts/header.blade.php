<header class="top-header-area d-flex align-items-center justify-content-between">
    <div class="left-side-content-area d-flex align-items-center">
        ...
        <div class="mobile-logo mr-3 mr-sm-4">
            <a href="#"><img src="{{asset('back/img/core-img/small-logo.png')}}" alt="آرم موبایل"></a>
        </div>
    ...
    <div class="right-side-navbar d-flex align-items-center justify-content-end">
        ...
        <ul class="right-side-content d-flex align-items-center">
            ...
            <li class="nav-item dropdown">
                <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('back/img/member-img/3.png')}}" alt=""></button>
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- User Profile Area -->
                    <div class="user-profile-area">
                        <div class="user-profile-heading">
                            ...
                            <div class="profile-img">
                                <img class="chat-img mr-2" src="{{asset('back/img/member-img/3.png')}}" alt="">
                            </div>
                            <!-- Profile Text -->
