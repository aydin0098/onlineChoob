<div class="ecaps-sidemenu-area">
    ...
    <div class="ecaps-logo">
        <a href="#"><img class="desktop-logo" src="{{asset('back/img/core-img/logo.png')}}" alt="لوگوی دسک تاپ"> <img class="small-logo" src="{{asset('back/img/core-img/small-logo.png')}}" alt="آرم موبایل"></a>
    </div>
