                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="bg-white rounded-3xl leading-10 p-4">
                                    <div class="relative">
                                        <a href="single-product.html" class="flex flex-col items-center justify-center">
                                            <img class="mb-4" src="{{asset('home/assets/images/product-1.jpg')}}" alt="">
                                        </a>
                                    ...
                                    <div class="text-center">
                                        <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دریل بتن کن میلی متری</h3></a>
                            ...
                            <div class="swiper-slide">
                                <div class="bg-white rounded-3xl leading-10 p-4">
                                    <div class="relative">
                                        <a href="single-product.html" class="flex flex-col items-center justify-center">
                                            <img class="mb-4" src="{{asset('home/assets/images/product-8.jpg')}}" alt="">
                                        </a>
                                        <div class="bg-yellow-500 absolute top-2 right-2 rounded-full w-10 h-10">
                                            <p class="flex items-center justify-center">30%</p>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="bg-white rounded-3xl leading-10 p-4">
                                    <div class="relative">
                                        <a href="single-product.html" class="flex flex-col items-center justify-center">
                                            <img class="mb-4" src="{{asset('home/assets/images/product-7.jpg')}}" alt="">
                                        </a>
                                        <div class="bg-yellow-500 absolute top-2 right-2 rounded-full w-10 h-10">
                                            <p class="flex items-center justify-center">30%</p>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دستگاه مدل Henzax</h3></a>
                                        <div class="flex justify-center gap-4 text-base mt-4">
                            ...
                            <div class="swiper-slide">
                                <div class="bg-white rounded-3xl leading-10 p-4">
                                    <div class="relative">
                                        <a href="single-product.html" class="flex flex-col items-center justify-center">
                                            <img class="mb-4" src="{{asset('home/assets/images/product-6.jpg')}}" alt="">
                                        </a>
                                        <div class="bg-yellow-500 absolute top-2 right-2 rounded-full w-10 h-10">
                                            <p class="flex items-center justify-center">30%</p>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دستگاه جوشکاری</h3></a>
                                        <div class="flex justify-center gap-4 text-base mt-4">
                    ...
                    <div class="bg-stone-800 rounded-3xl p-4">
                        <div class="flex flex-col leading-8">
                            ...
                            <div class="flex justify-center my-12">
                                <img class="w-48" src="{{asset('home/assets/images/off.png')}}" alt="">
                            </div>
