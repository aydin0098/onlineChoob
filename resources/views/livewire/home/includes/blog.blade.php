    ...
    <div class="container mx-auto max-w-screen-xl">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="bg-white p-4 rounded-3xl">
                <div class="relative">
                    <a href="single-page.html"><img class="rounded-2xl" src="{{asset('home/assets/images/blog-1.jpg')}}" alt=""></a>
            ...
            <div class="bg-white p-4 rounded-3xl">
                <div class="relative">
                    <a href="single-page.html"><img class="rounded-2xl" src="{{asset('home/assets/images/blog-2.jpg')}}" alt=""></a>
                    <div class="absolute top-4 left-4 bg-white border-t-4 border-yellow-400 p-2 px-3 rounded-xl">
                        <div class="flex flex-col">
                            <span class="font-YekanBakh-ExtraBold text-2xl">26</span>
                            <span class="font-YekanBakh-Bold">خرداد</span>
            ...
            <div class="bg-white p-4 rounded-3xl">
                <div class="relative">
                    <a href="single-page.html"><img class="rounded-2xl" src="{{asset('home/assets/images/blog-3.jpg')}}" alt=""></a>
                    <div class="absolute top-4 left-4 bg-white border-t-4 border-yellow-400 p-2 px-3 rounded-xl">
                        <div class="flex flex-col">
                            <span class="font-YekanBakh-ExtraBold text-2xl">26</span>
                            <span class="font-YekanBakh-Bold">خرداد</span>
                ...
                <div class="flex justify-between items-center mt-4">
                    <div>
                        <a href="single-page.html"><h3 class="font-YekanBakh-ExtraBold text-base">تمیز کردن لوازم کارگاهی</h3></a>
                    </div>
                    <div>
