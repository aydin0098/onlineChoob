            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="bg-white rounded-3xl leading-10 relative p-4">
                        <div class="flex items-center justify-center">
                            <div>
                                <a href="single-product.html"> <img class="w-32" src="{{asset('home/assets/images/product-4.jpg')}}" alt=""></a>
                            </div>
                            <div>
                ...
                <div class="swiper-slide">
                    <div class="bg-white rounded-3xl leading-10 relative p-4">
                        <div class="flex items-center justify-center">
                            <div>
                                <a href="single-product.html"> <img class="w-32" src="{{asset('home/assets/images/product-3.jpg')}}" alt=""></a>
                            </div>
                            <div>
                ...
                <div class="swiper-slide">
                    <div class="bg-white rounded-3xl leading-10 relative p-4">
                        <div class="flex items-center justify-center">
                            <div>
                                <a href="single-product.html"> <img class="w-32" src="{{asset('home/assets/images/product-2.jpg')}}" alt=""></a>
                            </div>
                            <div>
                ...
                <div class="swiper-slide">
                    <div class="bg-white rounded-3xl leading-10 relative p-4">
                        <div class="flex items-center justify-center">
                            <div>
                                <a href="single-product.html"> <img class="w-32" src="{{asset('home/assets/images/product-1.jpg')}}" alt=""></a>
                            </div>
                            <div>
                ...
                <div class="swiper-slide">
                    <div class="bg-white rounded-3xl leading-10 relative p-4">
                        <div class="flex items-center justify-center">
                            <div>
                                <a href="single-product.html"> <img class="w-32" src="{{asset('home/assets/images/product-8.jpg')}}" alt=""></a>
                            </div>
                            <div>
