    ...
    <div class="container mx-auto max-w-screen-xl">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="flex justify-center">
                            <img src="{{asset('home/assets/images/logo-1.png')}}" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="flex justify-center">
                            <img src="{{asset('home/assets/images/logo-2.png')}}" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="flex justify-center">
                            <img src="{{asset('home/assets/images/logo-3.png')}}" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="flex justify-center">
                            <img src="{{asset('home/assets/images/logo-5.png')}}" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="flex justify-center">
                            <img src="{{asset('home/assets/images/logo-6.png')}}" alt="">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="flex justify-center">
                            <img src="{{asset('home/assets/images/logo-4.png')}}" alt="">
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-12 gap-4 leading-8">
            <div class="col-span-12 lg:col-span-5">
                <img class="mb-4" src="{{asset('home/assets/images/logo.png')}}" alt="">
                <p>
            ...
            <div class="col-span-12 lg:col-span-3">
                ...
                <div class="flex items-center">
                    <img src="{{asset('home/assets/images/enamad_logo.png')}}" alt="">
                    <img src="{{asset('home/assets/images/samandehi_logo.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
